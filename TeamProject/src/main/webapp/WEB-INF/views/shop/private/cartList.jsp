	...
	<div class="listResult">
		...
		<div class="orderInfo">
			...
			<script>
				$("#check_module").click(function () {
			    	...
			    	IMP.request_pay({
				    	...
				    	*/
				    	...
				    	buyer_addr: '서울특별시 강남구 테헤란로 124 삼원타워 5층',
				...
				<div class="inputArea">
					<button id="check_module" type="button" class="order_btn">결제</button>
					<button type="submit" class="order_btn">결제 완료</button>
